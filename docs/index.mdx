...
The IYREE Python SDK provides a convenient interface to the IYREE platform, including DWH (StarRocks), Cube.js analytics, S3 object storage, and a Key-Value store.
